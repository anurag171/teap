...
// CONFIG
// ============================================================================
// Point this at your running FastAPI backend (teap-backend-complete.py).
// Change this one line when you deploy — nothing else in this file needs to change.
const API_BASE = 'http://localhost:8000/api';

// ============================================================================
// API SERVICE LAYER
// Maps 1:1 to the endpoints defined in teap-backend-complete.py
// ============================================================================
...
// ============================================================================
// SHARED STYLES (inline — no CSS framework dependency)
// ============================================================================
...
const styles = {
  ...
  tabButton: (active) => ({
    ...
    backgroundColor: 'transparent', border: 'none', borderBottomWidth: '2px', cursor: 'pointer',
          ...
          {scenarios.map((scenario) => (
            <div key={scenario.id} style={{ backgroundColor: 'white', borderRadius: '8px', border: '1px solid #e5e7eb', overflow: 'hidden', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
              <div
                ...
                style={{ padding: '24px', cursor: 'pointer', display: 'flex', justifyContent: 'space-between', alignItems: 'start' }}
              >
...
export default function TEAP() {
  ...
  const loadAll = useCallback(async () => {
    ...
    try {
      const [scenarioList, reportList] = await Promise.all([
        ...
        TEAPApi.listReports().catch(() => []) // reports endpoint is non-critical for initial load
      ]);
  ...
  const handleLoadEvidence = async (scenarioId) => {
